 ...
 */
require_once $absolutePath.'/Mail/Transport/Abstract.php';

/**
 * @see Zend_Mime
 */
require_once $absolutePath.'/Mime.php';

/**
 * @see Zend_Mime_Message
 */
require_once $absolutePath.'/Mime/Message.php';

/**
 * @see Zend_Mime_Part
 */
require_once $absolutePath.'/Mime/Part.php';

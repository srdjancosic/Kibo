jQuery(document).ready(function() {
	...
	$(".showhide_setting").live("click", function() { 
		...
		var show_or_hide = $(this).attr("show_or_hide");
		
		if(show_or_hide == 1) {
			$("#node_setting_"+lang).hide();
			$(this).attr('show_or_hide', '0');	
		}
		else {
			$("#node_setting_"+lang).show();
			$(this).attr('show_or_hide', '1');
		}
	});

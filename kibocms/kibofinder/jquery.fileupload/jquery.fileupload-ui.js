...
(function ($) {
    ...
    $.widget('blueimpUI.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            downloadTemplate: null,//$('#template-download'),
            ...
            add: function (e, data) {
                ...
                //override
                var new_file_list = new Array();
                
                $.each(data.files, function(index, value) {
                	new_file_list.push(value.name);// = $.extend(new_file_list, file_list, tmp);
                });
                
                var emptyList = new Array();
                var listing = ($(document).data("fileList") == undefined) ? emptyList : $(document).data("fileList");
                
                var tmp = $.merge(emptyList, listing);
                tmp = $.merge(tmp, new_file_list);
                $(document).data("fileList", tmp);
            ...
            // Callback for successful uploads:
                ...
                if (data.context) {
                    data.context.each(function (index) {
                        ...
                        var folder = $("#current_folder_name").val();
